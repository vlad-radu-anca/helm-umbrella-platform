...
*/}}
{{- define "topicOperator.name" -}}
{{- $global := dict }}
{{- if .Values.global }}
{{- $global = index .Values.global "topicOperator" | default dict }}
{{- end }}
{{- $local := index .Values "topicOperator" | default dict }}
...
Common labels
*/}}
{{- define "topicOperator.labels" -}}
{{- $global := dict }}
{{- if .Values.global }}
{{- $global = index .Values.global "topicOperator" | default dict }}
{{- end }}
{{- $local := index .Values "topicOperator" | default dict }}
helm.sh/chart: {{ include "topicOperator.chart" . }}
{{ include "topicOperator.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "topicOperator.selectorLabels" -}}
app.kubernetes.io/name: {{ include "topicOperator.name" . }}
...
*/}}
{{- define "topicOperator.serviceAccountName" -}}
{{- $global := dict }}
{{- if .Values.global }}
{{- $global = index .Values.global "topicOperator" | default dict }}
{{- end }}
...
{{- default (include "topicOperator.fullname" .) $svcAcct.name }}
{{- else }}
