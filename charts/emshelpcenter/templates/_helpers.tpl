...
*/}}
{{- define "emshelpcenter.name" -}}
{{- $global := dict }}
{{- if .Values.global }}
{{- $global = index .Values.global "emshelpcenter" | default dict }}
{{- end }}
{{- $local := index .Values "emshelpcenter" | default dict }}
...
Common labels
*/}}
{{- define "emshelpcenter.labels" -}}
{{- $global := dict }}
{{- if .Values.global }}
{{- $global = index .Values.global "emshelpcenter" | default dict }}
{{- end }}
{{- $local := index .Values "emshelpcenter" | default dict }}
helm.sh/chart: {{ include "emshelpcenter.chart" . }}
{{ include "emshelpcenter.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "emshelpcenter.selectorLabels" -}}
app.kubernetes.io/name: {{ include "emshelpcenter.name" . }}
...
*/}}
{{- define "emshelpcenter.serviceAccountName" -}}
{{- $global := dict }}
{{- if .Values.global }}
{{- $global = index .Values.global "emshelpcenter" | default dict }}
{{- end }}
...
{{- default (include "emshelpcenter.fullname" .) $svcAcct.name }}
{{- else }}
