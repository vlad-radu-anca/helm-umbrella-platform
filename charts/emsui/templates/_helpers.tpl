...
{{- $global := dict }}
{{- if .Values.global }}
{{- $global = index .Values.global "emsui" | default dict }}
{{- end }}
{{- $local := index .Values "emsui" | default dict }}
...
{{- end }}
{{- $local := index .Values "emsui" | default dict }}
helm.sh/chart: {{ include "emsui.chart" . }}
{{ include "emsui.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "emsui.selectorLabels" -}}
app.kubernetes.io/name: {{ include "emsui.name" . }}
...
*/}}
{{- define "emsui.serviceAccountName" -}}
{{- $global := dict }}
{{- if .Values.global }}
{{- $global = index .Values.global "emsui" | default dict }}
{{- end }}
...
{{- default (include "emsui.fullname" .) $svcAcct.name }}
{{- else }}
{{- default "default" $svcAcct.name }}
{{- end }}
{{- end }}

{{- define "emsui.Namespace" -}}
{{ .Release.Namespace }}
{{- end -}}
